...
RUN mkdir -p /usr/src/project_sig
...
COPY src /usr/src/project_sig/
WORKDIR /usr/src/project_sig
...
RUN chmod +x /usr/src/project_sig/tasks.py \
    && chmod +x /usr/src/project_sig/entrypoint.sh
...
# ENTRYPOINT /usr/src/project_sig/entrypoint.sh
