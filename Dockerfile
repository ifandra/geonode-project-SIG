...
RUN mkdir -p /usr/src/geonode_test
...
COPY src /usr/src/geonode_test/
WORKDIR /usr/src/geonode_test
...
RUN chmod +x /usr/src/geonode_test/tasks.py \
    && chmod +x /usr/src/geonode_test/entrypoint.sh
...
# ENTRYPOINT /usr/src/geonode_test/entrypoint.sh
